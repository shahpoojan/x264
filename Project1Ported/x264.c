 ...
 *****************************************************************************/
#ifndef X264_VERSION
#define X264_VERSION 0   //added by us
#endif
...
#include <signal.h>
#define _GNU_SOURCE
#include "getopt.h" //commented by us
...
#include "common1.h"
#include "x264.h"
//#include "mdate1.h" //added by us

#ifndef _MSC_VER
//#include "config.c" //commented by us
#endif
...
char *argvdef[] = {"program.exe", "-o", "out2.mkv", "input.yuv", "176x144"};
int argcdef = 5;
...
#define OPT_CQMFILE 305
        ...
        static struct option long_options[66];
            		...
            		long_options[1].name =      		"bitrate";
            		long_options[1].has_arg =required_argument;
            		long_options[1].flag =NULL;
            		long_options[1].val = 'B';
            		long_options[2].name = "bframes";
            		long_options[2].has_arg =required_argument;
            		long_options[2].flag =NULL;
            		long_options[2].val = 'b' ;
    				long_options[3].name = "no-b-adapt";
    				long_options[3].has_arg =no_argument;
    				long_options[3].flag = NULL;
    				long_options[3].val = OPT_NOBADAPT;
            		long_options[4].name = "b-bias";
            		long_options[4].has_arg =required_argument;
            		long_options[4].flag = NULL;
            		long_options[4].val = OPT_BBIAS;
            		long_options[5].name = "b-pyramid";
            		long_options[5].has_arg =no_argument;
            		long_options[5].flag = NULL;
            		long_options[5].val = OPT_BPYRAMID;
            		long_options[6].name = "min-keyint";
            		long_options[6].has_arg =required_argument;
            		long_options[6].flag = NULL;
            		long_options[6].val = 'i';
            		long_options[7].name = "keyint";
            		long_options[7].has_arg =required_argument;
            		long_options[7].flag = NULL;
            		long_options[7].val = 'I';
            		long_options[8].name = "scenecut";
            		long_options[8].has_arg =required_argument;
            		long_options[8].flag = NULL;
            		long_options[8].val = OPT_SCENECUT;
            		long_options[9].name = "nf";
            		long_options[9].has_arg =no_argument;
            		long_options[9].flag = NULL;
            		long_options[9].val = 'n';
            		long_options[10].name = "filter";
            		long_options[10].has_arg =required_argument;
            		long_options[10].flag = NULL;
            		long_options[10].val = 'f';
            		long_options[11].name = "no-cabac";
            		long_options[11].has_arg =no_argument;
            		long_options[11].flag = NULL;
            		long_options[11].val = OPT_NO_CABAC;
            		long_options[12].name = "qp";
            		long_options[12].has_arg =required_argument;
            		long_options[12].flag = NULL;
            		long_options[12].val = 'q';
            		long_options[13].name = "qpmin";
            		long_options[13].has_arg =required_argument;
            		long_options[13].flag = NULL;
            		long_options[13].val = OPT_QPMIN;
            		long_options[14].name = "qpmax";
            		long_options[14].has_arg =required_argument;
            		long_options[14].flag = NULL;
            		long_options[14].val = OPT_QPMAX;
            		long_options[15].name = "qpstep";
            		long_options[15].has_arg =required_argument;
            		long_options[15].flag = NULL;
            		long_options[15].val = OPT_QPSTEP;
            		long_options[16].name = "ref";
            		long_options[16].has_arg =required_argument;
            		long_options[16].flag = NULL;
            		long_options[16].val = 'r';
            		long_options[17].name = "no-asm";
            		long_options[17].has_arg = no_argument;
            		long_options[17].flag = NULL;
            		long_options[17].val = 'C';
            		long_options[18].name = "sar";
            		long_options[18].has_arg = required_argument;
            		long_options[18].flag = NULL;
            		long_options[18].val = 's';
            		long_options[19].name = "fps";
            		long_options[19].has_arg = required_argument;
            		long_options[19].flag = NULL;
            		long_options[19].val = OPT_FPS;
            		long_options[20].name = "frames";
            		long_options[20].has_arg = required_argument;
            		long_options[20].flag = NULL;
            		long_options[20].val = OPT_FRAMES;
            		long_options[21].name = "seek";
            		long_options[21].has_arg =required_argument;
            		long_options[21].flag = NULL;
            		long_options[21].val = OPT_SEEK;
            		long_options[22].name = "output";
            		long_options[22].has_arg =required_argument;
            		long_options[22].flag = NULL;
            		long_options[22].val = 'o';
            		long_options[23].name = "analyse";
            		long_options[23].has_arg =required_argument;
            		long_options[23].flag = NULL;
            		long_options[23].val = 'A';
            		long_options[24].name = "direct";
            		long_options[24].has_arg =required_argument;
            		long_options[24].flag = NULL;
            		long_options[24].val = OPT_DIRECT;
            		long_options[25].name = "weightb";
            		long_options[25].has_arg =no_argument;
            		long_options[25].flag = NULL;
            		long_options[25].val = 'w';
            		long_options[26].name = "me";
            		long_options[26].has_arg =required_argument;
            		long_options[26].flag = NULL;
            		long_options[26].val = OPT_ME;
            		long_options[27].name = "merange";
            		long_options[27].has_arg =required_argument;
            		long_options[27].flag = NULL;
            		long_options[27].val = OPT_MERANGE;
            		long_options[28].name = "subme";
            		long_options[28].has_arg =required_argument;
            		long_options[28].flag = NULL;
            		long_options[28].val = 'm';
            		long_options[29].name = "no-chroma-me";
            		long_options[29].has_arg =no_argument;
            		long_options[29].flag = NULL;
            		long_options[29].val = OPT_NO_CHROMA_ME;
            		long_options[30].name = "8x8dct";
            		long_options[30].has_arg =no_argument;
            		long_options[30].flag = NULL;
            		long_options[30].val = '8';
            		long_options[31].name = "level";
            		long_options[31].has_arg =required_argument;
            		long_options[31].flag = NULL;
            		long_options[31].val = OPT_LEVEL;
            		long_options[32].name = "ratetol";
            		long_options[32].has_arg =required_argument;
            		long_options[32].flag = NULL;
            		long_options[32].val = OPT_RATETOL;
            		long_options[33].name = "vbv-maxrate";
            		long_options[33].has_arg =required_argument;
            		long_options[33].flag = NULL;
            		long_options[33].val = OPT_VBVMAXRATE;
            		long_options[34].name = "vbv-bufsize";
            		long_options[34].has_arg =required_argument;
            		long_options[34].flag = NULL;
            		long_options[34].val = OPT_VBVBUFSIZE;
            		long_options[35].name = "vbv-init";
            		long_options[35].has_arg =required_argument;
            		long_options[35].flag = NULL;
            		long_options[35].val = OPT_VBVINIT;
            		long_options[36].name = "ipratio";
            		long_options[36].has_arg =required_argument;
            		long_options[36].flag = NULL;
            		long_options[36].val = OPT_IPRATIO;
            		long_options[37].name = "pbratio";
            		long_options[37].has_arg =required_argument;
            		long_options[37].flag = NULL;
            		long_options[37].val = OPT_PBRATIO;
            		long_options[38].name = "chroma-qp-offset";
            		long_options[38].has_arg =required_argument;
            		long_options[38].flag = NULL;
            		long_options[38].val = OPT_CHROMA_QP;
            		long_options[39].name = "pass";
            		long_options[39].has_arg =required_argument;
            		long_options[39].flag = NULL;
            		long_options[39].val = 'p';
            		long_options[40].name = "stats";
            		long_options[40].has_arg =required_argument;
            		long_options[40].flag = NULL;
            		long_options[40].val = OPT_RCSTATS;
            		long_options[41].name = "rceq";
            		long_options[41].has_arg =required_argument;
            		long_options[41].flag = NULL;
            		long_options[41].val = OPT_RCEQ;
            		long_options[42].name = "qcomp";
            		long_options[42].has_arg =required_argument;
            		long_options[42].flag = NULL;
            		long_options[42].val = OPT_QCOMP;
            		long_options[43].name = "qblur";
            		long_options[43].has_arg =required_argument;
            		long_options[43].flag = NULL;
            		long_options[43].val = OPT_QBLUR;
            		long_options[44].name = "cplxblur";
            		long_options[44].has_arg =required_argument;
            		long_options[44].flag = NULL;
            		long_options[44].val = OPT_CPLXBLUR;
            		long_options[45].name = "zones";
            		long_options[45].has_arg =required_argument;
            		long_options[45].flag = NULL;
            		long_options[45].val = OPT_ZONES;
            		long_options[46].name = "threads";
            		long_options[46].has_arg =required_argument;
            		long_options[46].flag = NULL;
            		long_options[46].val = OPT_THREADS;
            		long_options[47].name = "no-psnr";
            		long_options[47].has_arg =no_argument;
            		long_options[47].flag = NULL;
            		long_options[47].val = OPT_NOPSNR;
            		long_options[48].name = "quiet";
            		long_options[48].has_arg =no_argument;
            		long_options[48].flag = NULL;
            		long_options[48].val = OPT_QUIET;
            		long_options[49].name = "verbose";
            		long_options[49].has_arg =no_argument;
            		long_options[49].flag = NULL;
            		long_options[49].val = 'v';
            		long_options[50].name = "progress";
            		long_options[50].has_arg =no_argument;
            		long_options[50].flag = NULL;
            		long_options[50].val = OPT_PROGRESS;
            		long_options[51].name = "visualize";
            		long_options[51].has_arg =no_argument;
            		long_options[51].flag = NULL;
            		long_options[51].val = OPT_VISUALIZE;
            		long_options[52].name = "aud";
            		long_options[52].has_arg =no_argument;
            		long_options[52].flag = NULL;
            		long_options[52].val = OPT_AUD;
            		long_options[53].name = "cqm";
            		long_options[53].has_arg =required_argument;
            		long_options[53].flag = NULL;
            		long_options[53].val = OPT_CQM;
            		long_options[54].name = "cqmfile";
            		long_options[54].has_arg =required_argument;
            		long_options[54].flag = NULL;
            		long_options[54].val = OPT_CQMFILE;
            		long_options[55].name = "cqm4";
            		long_options[55].has_arg =required_argument;
            		long_options[55].flag = NULL;
            		long_options[55].val = OPT_CQM4;
            		long_options[56].name = "cqm4i";
            		long_options[56].has_arg =required_argument;
            		long_options[56].flag = NULL;
            		long_options[56].val = OPT_CQM4I;
            		long_options[57].name = "cqm4iy";
            		long_options[57].has_arg =required_argument;
            		long_options[57].flag = NULL;
            		long_options[57].val = OPT_CQM4IY;
            		long_options[58].name = "cqm4ic";
            		long_options[58].has_arg =required_argument;
            		long_options[58].flag = NULL;
            		long_options[58].val = OPT_CQM4IC;
            		long_options[59].name = "cqm4p";
            		long_options[59].has_arg =required_argument;
            		long_options[59].flag = NULL;
            		long_options[59].val = OPT_CQM4P;
            		long_options[60].name = "cqm4py";
            		long_options[60].has_arg =required_argument;
            		long_options[60].flag = NULL;
            		long_options[60].val = OPT_CQM4PY;
            		long_options[61].name = "cqm4pc";
            		long_options[61].has_arg =required_argument;
            		long_options[61].flag = NULL;
            		long_options[61].val = OPT_CQM4PC;
            		long_options[62].name = "cqm8";
            		long_options[62].has_arg =required_argument;
            		long_options[62].flag = NULL;
            		long_options[62].val = OPT_CQM8;
            		long_options[63].name = "cqm8i";
            		long_options[63].has_arg =required_argument;
            		long_options[63].flag = NULL;
            		long_options[63].val = OPT_CQM8I;
            		long_options[64].name = "cqm8p";
            		long_options[64].has_arg =required_argument;
            		long_options[64].flag = NULL;
            		long_options[64].val = OPT_CQM8P;
            		long_options[65].name = 0;
            		long_options[65].has_arg =0;
            		long_options[65].flag = 0;
            		long_options[65].val = 0;
        ...
        else if( !strncmp(optarg + strlen(optarg) - 4, ".mkv", 4) )
        {
