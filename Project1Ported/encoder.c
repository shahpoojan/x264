...
x264_t *x264_encoder_open   ( x264_param_t *param )
{
    ...
    {
    	char *d = (char *)(malloc (strlen (h->param.rc.psz_stat_out) + 1));
    	 strcpy (d,h->param.rc.psz_stat_out);
    	 h->param.rc.psz_stat_out= d;
    }
    if( h->param.rc.psz_stat_in )
    {
    	char *d = (char *)(malloc (strlen (h->param.rc.psz_stat_in) + 1));
    	 strcpy (d,h->param.rc.psz_stat_in);
    	 h->param.rc.psz_stat_in= d;
    }
    if( h->param.rc.psz_rc_eq )
    {
    	char *d = (char *)(malloc (strlen (h->param.rc.psz_rc_eq) + 1));
    	 strcpy (d,h->param.rc.psz_rc_eq);
    	 h->param.rc.psz_rc_eq= d;
    }
